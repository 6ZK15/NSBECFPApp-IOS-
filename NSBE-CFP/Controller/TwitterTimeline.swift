...
class TwitterTimeline: TWTRTimelineViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        dataSource = TWTRUserTimelineDataSource(screenName: "nsbecfp", apiClient: TWTRAPIClient())
        TWTRTweetView.appearance().backgroundColor = UIColor.black
        TWTRTweetTableViewCell.appearance().backgroundColor = UIColor.black
        TWTRTweetView.appearance().primaryTextColor = UIColor.black
        TWTRTweetView.appearance().linkTextColor = UIColor.black
    }
